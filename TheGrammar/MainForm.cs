...
public partial class MainForm : Form
{
    ...
    private readonly GlobalHotKeyService _globalHotKeyHandler;
    ...
    public MainForm(IHost app)
    {
        ...
        _globalHotKeyHandler = app.Services.GetRequiredService<GlobalHotKeyService>();
        _eventService = app.Services.GetRequiredService<PushService>();


        _globalHotKeyHandler.SetHook(_globalHotKeyHandler._proc);
        _globalKeyHandlerHookId = GlobalHotKeyService._hookID;
    ...
    private void Main_FormClosing(object sender, FormClosingEventArgs e)
    {
        ...
        GlobalHotKeyService.UnhookWindowsHookEx(_globalKeyHandlerHookId);
    }
}
